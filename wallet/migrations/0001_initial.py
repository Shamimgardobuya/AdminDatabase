    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_a', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='acc', to='wallet.account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime.now)),
                ('account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AccountA', to='wallet.account')),
            ],
        ),
        migrations.CreateModel(
            name='Card',
